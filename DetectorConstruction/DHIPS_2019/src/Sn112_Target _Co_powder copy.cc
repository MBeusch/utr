...
Sn112_Target_Co_powder::Sn112_Target_Co_powder(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Sn112_Target_Co_powder::Construct(G4ThreeVector global_coordinates) {
  ...
  G4double co59_I_density = 0.987 * g / cm3; // Density of Co powder used in the experiment (from target mass and thickness). Natural density cobalt from Wikipedia = 8.90 * g / cm3.
  ...
  vector<G4Material *> target_materials = {Co_powder, nat_Al, sn112_material, nat_Al, Co_powder};
  vector<G4Tubs *> target_solids;
  vector<G4LogicalVolume *> target_logicals;
  vector<G4Color> target_colors = {G4Color::Red(), G4Color::Blue(), G4Color::Green(), G4Color::Blue(), G4Color::Red()};
